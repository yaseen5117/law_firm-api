                                ...
                                <tbody>
                                    ...
                                    <tr data-delete="{{ route($route_name.'.destroy', $record) }}">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route($route_name.'.edit', $record) }}"><i class="fa fa-pencil btn btn-primary btn-sm"></i></a>
                                            <a href="#" data-delete-trigger><i class="fa fa-trash btn btn-danger btn-sm"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
